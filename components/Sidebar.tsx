...
const Sidebar: React.FC<SidebarProps> = ({ chats, activeChatId, onNewChat, onSelectChat, onDeleteChat, isOpen, setIsOpen, isCollapsed, setIsCollapsed, onLogout, onOpenSettings }) => {
        ...
        <div className="w-64 flex flex-col h-full">
            ...
            <div className="p-4 border-t border-border-color space-y-2">
                ...
                >
                    ...
                    <span className="ml-3 text-sm font-medium">Agent Settings</span>
                </button>
                <button
                    onClick={toggleTheme}
                    className="w-full flex items-center p-2 rounded-lg text-text-secondary hover:bg-bubble-user hover:text-text-primary transition-colors"
